...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "settings.showLiveRate.hint": "Estimate only — based on recent local usage spikes, may not be exact.",
        "settings.privacy": "Reads local Codex, Claude Code, ZCode, Cursor, Grok, Pi, and Amp usage. Nothing is uploaded.",
        "tier.hush": "Hush",
        "tier.glow": "Glow",
    ...
    private static let zh: [String: String] = [
        ...
        "settings.showLiveRate.hint": "仅为预估，依据近期本机用量波动，可能不完全准确。",
        "settings.privacy": "读取本机 Codex / Claude Code / ZCode / Cursor / Grok / Pi / Amp 用量；不上传。",
        "tier.hush": "微火",
        "tier.glow": "小火",
        "tier.crackle": "中火",
        "tier.roar": "旺火",
    ...
    private static let ja: [String: String] = [
        ...
        "settings.showLiveRate": "リアルタイム消費を表示",
        "settings.showLiveRate.hint": "推定値です。直近のローカル利用から概算しており、正確でない場合があります。",
        "settings.privacy": "Codex / Claude Code / ZCode / Cursor / Grok / Pi / Amp のローカル利用を読み取ります。アップロードしません。",
        "tier.hush": "静火",
        "tier.glow": "ほのか",
        "tier.crackle": "ぱちぱち",
        "tier.roar": "ごうごう",
    ...
    private static let ko: [String: String] = [
        ...
        "settings.showLiveRate": "실시간 토큰 소모 표시",
        "settings.showLiveRate.hint": "추정치입니다. 최근 로컬 사용량으로 대략 계산하며, 정확하지 않을 수 있습니다.",
        "settings.privacy": "Codex / Claude Code / ZCode / Cursor / Grok / Pi / Amp 로컬 사용량을 읽습니다. 업로드하지 않습니다.",
        "tier.hush": "고요",
        "tier.glow": "은은",
        "tier.crackle": "타닥",
        "tier.roar": "활활",
